...
<!-- start: Content -->
    ...
    <div class="row-fluid sortable">
        ...
        action="{{ url('/update-product/'.$info->product_id) }}"
        method="post"
        ...
        <fieldset>
            ...
            <div class="control-group hidden-phone">
                ...
                <div class="controls">
                    <textarea
                        ...
                        rows="3"
                        required="required">{{$info-> product_description1 }}</textarea>
                </div>
            </div>
            ...
            <div class="control-group hidden-phone">
                ...
                <div class="controls">
                    <textarea
                        ...
                        rows="3"
                        required="required">{{$info-> product_description2 }}</textarea>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="checkbox" class="form-control" name="product_status" value="{{$info-> product_status }}">
                </div>
            </div>
