...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        {{-- <li><a href="{{URL::to('/admindashboard')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	 --}}
                        
						<li><a href="{{URL::to('/all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Category</span></a></li>
						...
						<li><a href="{{URL::to('/transaksi-product')}}"><i class="icon-edit"></i><span class="hidden-tablet"> Transaksi</span></a></li>
	...
	<script types="text/javascript" src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.4.0/bootbox.min.js')}}"></script>

	<script>
	$(document).on("click", "#delete", function(e){
		e.preventDefault();
		var link = $(this).attr("href");
		bootbox.confirm("Yakin ingin delete?", function(confirmed){
