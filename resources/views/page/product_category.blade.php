 ...
 <div class="product-big-title-area">
    ...
    <div class="single-product-area">
        ...
        <div class="container">
          ...
          <div class="container">
            <div class="row">
            @foreach( $all_product_category as $v_categoryyy)
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="{{URL::to($v_categoryyy->product_image)}}" alt="">
                        </div>
                        <h2><a href="{{URL::to('/view-product/'.$v_categoryyy->product_id)}}">{{$v_categoryyy->product_name}}</a></h2>
                        <div class="product-carousel-price">
                            <ins>Rp.{{$v_categoryyy->product_price2}}</ins> <del>Rp.{{$v_categoryyy->product_price}}</del>
                        </div>  
                ...
                <div class="col-md-12">
                    <div class="product-pagination text-center">
                        ...
                        <div class="related-products-wrapper">
                            ...
                            @foreach( $all_product_category as $v_product)
                                <div class="single-product">
                                    <div class="product-f-image">
                                        ...
                                        <div class="product-hover">
                                            ...
                                            <a href="{{URL::to('/view-product/'.$v_product->product_id)}}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        </div>
                                    </div>
